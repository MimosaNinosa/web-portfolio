...
const SITE = {
  profile: {
    name: "Lee Chun Yong",
    roleTag:
      "Cybersecurity Engineer — Trusted Execution & Applied Cryptography",
    location: "Singapore · SUTD",
    status: "OPEN TO OPPORTUNITIES", // shown as the pulsing status pill
    tagline:
      "I build systems that keep data private even while it's being computed on from a TEE-backed biometric pipeline at Singapore's HTX, to a homelab wired end-to-end with WireGuard, nftables, and encrypted backups.",
